...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rss_reader_rssfeed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=500)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=9999)),
            ('website_url', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'rss_reader', ['RSSFeed'])


    def backwards(self, orm):
        # Deleting model 'RSSFeed'
        db.delete_table(u'rss_reader_rssfeed')
