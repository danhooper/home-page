...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_health_websitehealthchecker', (
        ...
        db.send_create_signal(u'website_health', ['WebsiteHealthChecker'])


    def backwards(self, orm):
        # Deleting model 'WebsiteHealthChecker'
        db.delete_table(u'website_health_websitehealthchecker')
    ...
    models = {
        ...
        u'website_health.websitehealthchecker': {
